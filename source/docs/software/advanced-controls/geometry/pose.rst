...
Rotation in 2 dimensions is represented by WPILib's ``Rotation2d`` class ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/math/geometry/Rotation2d.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/classwpi_1_1math_1_1_rotation2d.html), :external:py:class:`Python <wpimath.Rotation2d>`). This class has an angle component, which represents the robot's rotation relative to an axis on a 2-dimensional coordinate system. Positive rotations are counterclockwise.
