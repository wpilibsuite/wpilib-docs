...
.. tab-set-code::
  ...
  .. remoteliteralinclude:: https://raw.githubusercontent.com/robotpy/mostrobotpy/2027.0.0a7/examples/robot/ElevatorTrapezoidProfile/robot.py
    :language: python
    :lines: 8-
    :lineno-match:
