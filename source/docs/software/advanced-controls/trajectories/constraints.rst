...
See the source code ([Java](https://github.com/wpilibsuite/allwpilib/tree/v2027.0.0-alpha-7/wpimath/src/main/java/org/wpilib/math/trajectory/constraint), [C++] (https://github.com/wpilibsuite/allwpilib/tree/v2027.0.0-alpha-2/wpimath/src/main/native/include/frc/trajectory/constraint)) for the WPILib-provided constraints for more examples on how to write your own custom trajectory constraints.
