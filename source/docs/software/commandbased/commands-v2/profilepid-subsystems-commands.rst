...
.. tab-set::
   ...
   .. tab-item:: Java
      ...
      .. remoteliteralinclude:: https://raw.githubusercontent.com/wpilibsuite/allwpilib/v2027.0.0-alpha-7/wpilibjExamples/src/main/java/org/wpilib/examples/rapidreactcommandbot/subsystems/Drive.java
         :language: java
         :lines: 5-
         :lineno-match:
   ...
   .. tab-item:: C++ (Header)
      ...
      .. remoteliteralinclude:: https://raw.githubusercontent.com/wpilibsuite/allwpilib/v2027.0.0-alpha-7/wpilibcExamples/src/main/cpp/examples/RapidReactCommandBot/include/subsystems/Drive.hpp
         :language: c++
         :lines: 5-
         :lineno-match:
   ...
   .. tab-item:: C++ (Source)
      ...
      .. remoteliteralinclude:: https://raw.githubusercontent.com/wpilibsuite/allwpilib/v2027.0.0-alpha-7/wpilibcExamples/src/main/cpp/examples/RapidReactCommandBot/cpp/subsystems/Drive.cpp
         :language: c++
         :lines: 5-
         :lineno-match:
