...
.. tab-set::
   ...
   .. tab-item:: Python
      ...
      .. remoteliteralinclude:: https://raw.githubusercontent.com/robotpy/mostrobotpy/2027.0.0a6/examples/robot/DriveDistanceOffboard/subsystems/drivesubsystem.py
         :language: python
         :lines: 5-
         :lineno-match:
